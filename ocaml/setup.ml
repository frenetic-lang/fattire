...
(* OASIS_START *)
(* DO NOT EDIT (digest: f64ae27e2eb02ba6579013c3da1f6cb5) *)
(*
...
let setup_t =
  {
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "\172\026\025n{\n]\199\184\1687\237W\197\213O";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
